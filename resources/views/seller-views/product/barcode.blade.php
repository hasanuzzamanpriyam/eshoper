                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <th>
                                        <input id="limit" type="number" name="limit" min="1" class="form-control"
                                               value="{{ request('limit') }}">
                                        <span
                                            class="text-info mt-1 d-block">{{ translate('maximum_quantity_270') }}</span>
                                    </th>
                ...
                @for ($i = 0; $i < count($array); $i++)
                    <div class="item style24">
                        ...
                        @if ($product->code !== null)
                            <div
                                class="barcode_image d-flex justify-content-center">{!! DNS1D::getBarcodeHTML($product->code, 'C128') !!}</div>
