                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex gap-3 justify-content-lg-end">
                                ...
                                <select name="delivery_withdraw_status_filter" onchange="status_filter(this.value)"
                                    ...
                                    <option value="all" {{session()->has('delivery_withdraw_status_filter') && session('delivery_withdraw_status_filter') == 'all' ? 'selected' : ''}}>
                                        {{translate('all')}}</option>
                                    <option value="approved" {{session()->has('delivery_withdraw_status_filter') && session('delivery_withdraw_status_filter') == 'approved' ? 'selected' : ''}}>
                                        {{translate('approved')}}</option>
                                    <option value="denied" {{session()->has('delivery_withdraw_status_filter') && session('delivery_withdraw_status_filter') == 'denied' ? 'selected' : ''}}>
                                        {{translate('denied')}}</option>
                                    <option value="pending" {{session()->has('delivery_withdraw_status_filter') && session('delivery_withdraw_status_filter') == 'pending' ? 'selected' : ''}}>
