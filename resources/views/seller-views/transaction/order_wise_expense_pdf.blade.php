                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{translate('transaction_date')}}</th>
                                    <td class="p-0" style="padding: 3px 0">: {{ date_format($transaction->order_transaction->updated_at, 'd F Y') }}</td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{translate('order_id')}}</th>
        ...
        <tr>
            <td class="pt-0">
                <table class="bs-0 __product-table inter">
                    <tbody>
                        <tr>
                            <td class="text-center" style="background-color: #0177CD important; color: white; font-weight: bold">{{translate('SL')}}</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(($transaction->coupon_discount_bearer == 'seller'?$transaction->discount_amount:0) + ($transaction->free_delivery_bearer=='seller'?$transaction->extra_discount:0))) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
