                ...
                <div class="d-flex flex-wrap w-100 gap-3 align-items-center">
                    ...
                    <form action="" method="GET" class="mb-0">
                        ...
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" value="{{ $search }}" name="search" class="form-control" placeholder="{{ translate('search_by_order_id')}}" aria-label="Search orders" required>
