                ...
                <div class="d-flex flex-wrap w-100 gap-3 align-items-center">
                    ...
                    <div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a class="dropdown-item" href="{{ route('seller.report.product-stock-export', ['category_id' => request('category_id'), 'sort' => request('sort'), 'search' => request('search')]) }}">{{translate('excel')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
