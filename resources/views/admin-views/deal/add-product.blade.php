                    ...
                    <form action="{{route('admin.deal.add-product',[$deal['id']])}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-3">
                                    <label for="top_selling_products" class="title-color">{{ translate('top_Selling_Products')}}</label>
                                    <button type="button" class="form-control btn btn-outline-primary js-select-top-selling-products" id="top_selling_products_btn">
                                        {{translate('show_top_selling_products')}}
                                    </button>
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="low_stock_products" class="title-color">{{ translate('low_Stock_Products')}}</label>
                                    <button type="button" class="form-control btn btn-outline-primary js-select-low-stock-products" id="low_stock_products_btn">
                                ...
                                <div class="col-md-3 mt-3">
                                    <label class="title-color">{{ translate('rating')}}</label>
                                    <div class="d-flex gap-2">
                                        <select id="rating_filter" class="form-control">
                                            <option value="">{{translate('select_rating')}}</option>
                                            <option value="5">5 {{translate('star')}}</option>
                                            <option value="4">4+ {{translate('star')}}</option>
                                            <option value="3">3+ {{translate('star')}}</option>
                                            <option value="2">2+ {{translate('star')}}</option>
                                            <option value="1">1+ {{translate('star')}}</option>
                                        </select>
                                        <button type="button" class="btn btn-primary js-select-rating" id="rating_btn">
                                            {{translate('show')}}
                                        </button>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.js-select-shop').on('change', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when shop is selected
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
                $('#max_price').val('');
                ...
                $('#rating_btn').removeClass('btn-primary').addClass('btn-outline-primary');
                if (currentShopId) {
            ...
            $('.js-select-brand').on('change', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when brand is selected
                $('#shop_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
                $('#max_price').val('');
            ...
            $('.js-select-category').on('change', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when category is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#min_price').val('');
                $('#max_price').val('');
            ...
            $('.js-select-discounted').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when discounted is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-featured-deal').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when featured deal is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-delivery-free').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when delivery free is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-cash-on-delivery').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when cash on delivery is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-latest-products').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when latest products is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-top-selling-products').on('click', function () {
                currentTopSellingProducts = !currentTopSellingProducts;
                currentShopId = ''; // Reset shop when top selling products is selected
                currentBrandId = ''; // Reset brand when top selling products is selected
                currentCategoryId = ''; // Reset category when top selling products is selected
                currentDiscounted = false; // Reset discounted when top selling products is selected
                currentFeaturedDeal = false; // Reset featured deal when top selling products is selected
                currentDeliveryFree = false; // Reset delivery free when top selling products is selected
                ...
                currentRatingFilter = false; // Reset rating filter when top selling products is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-low-stock-products').on('click', function () {
                currentLowStockProducts = !currentLowStockProducts;
                currentShopId = ''; // Reset shop when low stock products is selected
                currentBrandId = ''; // Reset brand when low stock products is selected
                currentCategoryId = ''; // Reset category when low stock products is selected
                currentDiscounted = false; // Reset discounted when low stock products is selected
                currentFeaturedDeal = false; // Reset featured deal when low stock products is selected
                currentDeliveryFree = false; // Reset delivery free when low stock products is selected
                ...
                currentRatingFilter = false; // Reset rating filter when low stock products is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            $('.js-select-price-range').on('click', function () {
                ...
                currentRatingFilter = false; // Reset rating filter when price range is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#rating_filter').val('');
            ...
            $('.js-select-rating').on('click', function () {
                currentRatingFilter = true;
                currentShopId = ''; // Reset shop when rating is selected
                currentBrandId = ''; // Reset brand when rating is selected
                currentCategoryId = ''; // Reset category when rating is selected
                currentDiscounted = false; // Reset discounted when rating is selected
                currentFeaturedDeal = false; // Reset featured deal when rating is selected
                currentDeliveryFree = false; // Reset delivery free when rating is selected
                currentCashOnDelivery = false; // Reset cash on delivery when rating is selected
                currentLatestProducts = false; // Reset latest products when rating is selected
                currentTopSellingProducts = false; // Reset top selling products when rating is selected
                currentLowStockProducts = false; // Reset low stock products when rating is selected
                currentPriceRange = false; // Reset price range when rating is selected
                $('#shop_id').val('');
                $('#brand_id').val('');
                $('#category_id').val('');
                $('#min_price').val('');
            ...
            function fetchModalProducts(append = false) {
                ...
                if (currentTopSellingProducts) {
                    requestData.top_selling_products = 1;
                }
                ...
                if (currentRatingFilter) {
                    requestData.rating = $('#rating_filter').val();
                }
