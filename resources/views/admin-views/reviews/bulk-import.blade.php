...
@section('title', translate('review_Bulk_Import'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            ...
            <div class="col-md-12 mt-2">
                <form class="product-form" action="{{route('admin.reviews.bulk-import-data')}}" method="POST"
                    ...
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            ...
                            <a href="{{route('admin.reviews.download-template')}}"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="uploadDnD">
                                                ...
                                                <input type="file" name="reviews_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold" id="inputFile"
