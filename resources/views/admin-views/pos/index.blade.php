                    ...
                    <form action="{{route('admin.pos.customer-store')}}" method="post" id="product_form"
                        ...
                        @csrf
                            <div class="row pl-2" >
                                ...
                                {{-- No Need last name, full name is above --}}
                            ...
                            <div class="row pl-2" >
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" value="{{ old('email') }}"  placeholder="{{translate('ex')}}: ex@example.com">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" >{{translate('phone')}}</label>
                                        <input type="text" name="phone" class="form-control" value="{{ old('phone') }}"  placeholder="{{translate('phone')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row pl-2" >
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country" class="form-control" value="{{ old('country') }}"  placeholder="{{translate('country')}}">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" value="{{ old('address') }}"  placeholder="{{translate('address')}}">
                                    </div>
                                </div>
                            </div>
