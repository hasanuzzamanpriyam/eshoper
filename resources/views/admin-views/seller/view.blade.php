                        ...
                        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus')}}" method="POST">
                                ...
                                <button type="submit"
                                        ...
                                        <a class="btn btn-primary ml-2" data-toggle="tooltip" data-placement="top" data-title="Login as {{$seller->shop? $seller->shop->name : translate("shop_Name")}}" href="{{route('admin.sellers.login-as-seller',[$seller['id'],$seller['phone'],$seller['email']])}}" target="_blank">Login as Seller</a>
                            </form>
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus')}}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$seller->id}}">
