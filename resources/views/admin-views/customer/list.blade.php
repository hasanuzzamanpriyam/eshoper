                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <form action="{{route('admin.customer.status-update')}}" method="post" id="customer_status{{$customer['id']}}_form" class="customer_status_form mt-1">
                                        @csrf
                                    ...
                                    <a class="btn btn-sm btn--primary" data-toggle="tooltip" data-placement="top" data-title="Login as {{$customer['f_name'].' '.$customer['l_name']}}" href="{{route('admin.customer.login-as-customer',[$customer['id']])}}" target="_blank">Login</a>
                                </div>
                            </td>
