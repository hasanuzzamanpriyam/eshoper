            ...
            <div class="row gy-4">
                    ...
                    <div class="card">
                        <div class="p-3 px-xl-4 py-sm-5">
                            <div class="text-center">
                                <img width="160" class="mb-4" src="{{asset('assets/back-end/img/email-template/change-pass.png')}}" alt="">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="card">
                        <div class="p-3 px-xl-4 py-sm-5">
                            <div class="text-center">
                                <img width="100" class="mb-4" src="{{asset('assets/back-end/img/email-template/store-withdraw.png')}}" alt="">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/1.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/5.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/2.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/3.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/4.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/6.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/7.png')}}" loading="lazy" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3" src="{{asset('assets/back-end/img/email-template/8.png')}}" loading="lazy" alt="">
