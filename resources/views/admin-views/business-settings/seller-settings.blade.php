                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="commission" value="{{isset($commission)?$commission->value:0}}" placeholder="{{translate('ex: 70')}}" min="0" max="100">
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                <label class="switcher" for="seller_pos">
                                    <input type="checkbox" class="switcher_input" name="seller_pos" id="seller_pos" value="1"
                                     {{$seller_pos==1?'checked':''}}
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                <label class="switcher" for="seller_registration">
                                    <input type="checkbox" class="switcher_input" name="seller_registration" id="seller_registration" {{$seller_registration==1?'checked':''}} value="1"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                <label class="switcher" for="minimum_order_amount_by_seller">
                                    <input type="checkbox" value="1" class="switcher_input" name="minimum_order_amount_by_seller" id="minimum_order_amount_by_seller" {{ $minimum_order_amount_by_seller == 1 ? 'checked' : '' }}
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <label class="title-color mb-0 {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}" for="product_wise_shipping_cost_approval">
                                ...
                                <span class="text-info">( {{translate('if_the_shipping_responsibility_is_inhouse_and_product_wise_shipping_is_activated_then_this_function_will_work')}} )</span>
                            </label>
                        </div>
                    </div>
                </div>
