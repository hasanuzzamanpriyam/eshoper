...
@section('title', translate('fraudshield'))
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="d-flex align-items-center gap-2 justify-content-between mb-3">
                        <h4 class="text-capitalize mb-0">{{translate('fraudshield_api_setup')}}</h4>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-aliceblue border border-color-primary-light p-4 dropdown-w-lg">
                                ...
                                <p class="title-color font-weight-medium mb-0">{{ translate('get_your_api_key_from_fraudshield_bd_dashboard') }}</p>
                            </div>
                        </div>
                    </div>
