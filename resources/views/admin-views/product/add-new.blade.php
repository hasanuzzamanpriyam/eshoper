    ...
    <form class="product-form text-start" action="{{ route('admin.product.store') }}" method="POST"
        ...
        <div class="card">
            <div class="px-4 pt-3">
                ...
                @php($default_lang = 'en')
                @php($languages = json_decode($language, true))
                @if(is_array($languages) && count($languages) > 0)
                @php($default_lang = $languages[0])
                @endif
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="additional_shipping_cost">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="0" step="1"
                                placeholder="{{ translate('additional_shipping_cost_per_extra_unit') }}"
                            ...
                            <div class="form-group w-100">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_meta_image_viewer" class="h-auto bg-white"
                                                src="{{asset('assets/back-end/img/400x400/img2.jpg')}}"
                                                onerror="this.classList.add('d-none')">
                                        </div>
                                        <div
