                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <div class="d-flex align-items-center justify-center gap-2">
                                <label class="title-color mb-0">{{ translate('cash_on_delivery') }}</label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" name="is_cash_on_delivery" value="1" {{ old('is_cash_on_delivery') ? 'checked' : '' }}>
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_img_viewer" class="h-auto aspect-1 bg-white" src="{{asset('assets/back-end/img/400x400/img2.jpg')}}" onerror="this.classList.add('d-none')">
                                        </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="custom_upload_input position-relative border-dashed-2">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                            <img id="additional_Image_1" class="h-auto aspect-1 bg-white" src="{{asset('assets/back-end/img/400x400/img2.jpg')}}" onerror="this.classList.add('d-none')">
                                        </div>
                                        <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{asset('assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
                            ...
                            <div class="form-group w-100">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_meta_image_viewer" class="h-auto bg-white" src="{{asset('assets/back-end/img/400x400/img2.jpg')}}" onerror="this.classList.add('d-none')">
                                        </div>
                                        <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{asset('assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
...
<script>
    ...
    function add_more_customer_choice_option(i, name) {
        ...
        $('#customer_choice_options').append(
            ...
            '" hidden><div class=""><input type="text" class="form-control" name="choice_options_' + i + '[]" placeholder="{{ translate('
    ...
    $('#colors-selector').on('change', function() {
        ...
        $('.remove_button').on('click', function() {
            alert('ok');
            $(this).parents('.upload_images').find('.color_image').attr('src', '{{ asset('
                assets / back - end / img / 400 x400 / img2.jpg ') }}')
        })
    });
                    ...
                    $.post({
                        ...
                        success: function(data) {
                            ...
                            if (data.errors) {
                                ...
                                console.log('Product validation successful, submitting form...');
                                toastr.success(
                        ...
                        error: function(xhr, status, error) {
                            ...
                            var errorMsg = 'An error occurred while saving the product. Please check the form and try again.';
                            try {
...
<script>
    (function() {
        ...
        try {
            ...
            if (window.CKEDITOR) {
                document.querySelectorAll('.textarea').forEach(function(el, idx) {
                    if (!el.id) el.id = 'ckeditor_fallback_' + idx;
                    CKEDITOR.replace(el.id, {
                        contentsLangDirection: dir
                    });
                });
