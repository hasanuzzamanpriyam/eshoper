...
<div class="__inline-9 rtl">
    <!-- Icon Section with full width background -->
    <div class="w-100" style="background: {{$web_config['primary_color']}}10;">
        <div class="d-flex justify-content-center text-center {{Session::get('direction') === "rtl" ? 'text-md-right' : 'text-md-left'}}" style="max-width: 80rem; margin: 0 auto; padding:20px;">
            ...
            <div class="col-md-3 d-flex justify-content-center">
                <div>
                    <a href="{{route('blogs')}}">
                        <div class="text-center">
                            <img class="size-60" src="{{asset("assets/front-end/png/blogging.png")}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="m-0">
                                {{ translate('blogs')}}
    ...
    <footer class="page-footer font-small mdb-color rtl">
        <!-- Footer Links with full width background -->
        <div class="w-100" style="background:{{$web_config['primary_color']}}20;">
            <div class="container-fluid" style="max-width: 80rem; margin: 0 auto;">
                <div class="pt-4">
                        ...
                        <div class="row text-center {{Session::get('direction') === "rtl" ? 'text-md-right' : 'text-md-left'}} mt-3 pb-3 ">
                            ...
                            <div class="col-md-3 footer-web-logo">
                                ...
                                @if ($_SERVER['REQUEST_URI'] == '/')
                                    <h1>eShoper Ecommerce: eShoper Online Shopping</h1>
                                @else
                                    <P>eShoper Ecommerce: eShoper Online Shopping</p>
                                @endif
                                ...
                                <div class="row">
                                    <div class="col-md-3 footer-padding-bottom">
                                        ...
                                        <ul class="widget-list __pb-10px">
                                            ...
                                            @endif
                                            <li class="widget-list-item"><a class="widget-list-link" href="{{route('products',['data_from'=>'featured','page'=>1])}}">{{translate('featured_products')}}</a></li>
                                            <li class="widget-list-item"><a class="widget-list-link" href="{{route('products',['data_from'=>'latest','page'=>1])}}">{{translate('latest_products')}}</a></li>
                                            <li class="widget-list-item"><a class="widget-list-link" href="{{route('products',['data_from'=>'best-selling','page'=>1])}}">{{translate('best_selling_product')}}</a></li>
                                            <li class="widget-list-item"><a class="widget-list-link" href="{{route('products',['data_from'=>'top-rated','page'=>1])}}">{{translate('top_rated_product')}}</a></li>
                                            <li class="widget-list-item"><a class="widget-list-link" href="{{route('blogs')}}">{{translate('blogs')}}</a></li>
                                        </ul>
                                    </div>
        ...
        <!-- Bottom Footer with full width background -->
        <div class="w-100" style="background: rgba(255, 255, 255, 0.05);">
            <div class="container-fluid" style="max-width: 80rem; margin: 0 auto;">
                <div class="container">
