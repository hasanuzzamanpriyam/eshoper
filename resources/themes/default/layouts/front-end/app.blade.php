            ...
            success: function (data) {
                ...
                if (data.value == 1) {
					...
					dataLayer.push({
						...
						'ecommerce': {
							currency: "BDT",
							value: "added to wishlist", //response.price,
							item: {
								brand_id: data.productData.brand_id,
								categories: data.productData.categories,
								code: data.productData.code,
								discount: data.productData.discount,
								item_name: data.productData.item_name,
								item_id: data.productData.product_id,
								price: data.productData.price,
								sale_price: data.productData.sale_price,
								reviews_count: data.productData.reviews_count,
								stock: data.productData.stock,
								seller_id: data.productData.seller_id,
								tax: data.productData.tax
							}
						}
					});
					...
					dataLayer.push({
						...
						'ecommerce': {
							currency: "BDT",
							value: "removed from wishlist", //response.price,
							item: {
								brand_id: data.productData.brand_id,
								categories: data.productData.categories,
								code: data.productData.code,
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
						...
						dataLayer.push({
							...
							'ecommerce': {
								currency: "BDT",
								value: ( response.price - response.discount ) * response.quantity,
								items: [
									{
										...
										sale_price: response.price - response.discount,
