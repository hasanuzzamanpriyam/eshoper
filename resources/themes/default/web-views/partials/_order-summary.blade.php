...
<div class="bottom-sticky3 bg-white p-3 shadow-sm w-100 d-lg-none">
    <div class="d-flex justify-content-center align-items-center fs-14 mb-2">
        ...
        &nbsp; <strong class="text-base" id="total-price-value-mobile">{{\App\CPU\Helpers::currency_converter($sub_total+$total_tax+$total_shipping_cost-$coupon_dis-$total_discount_on_product-$order_wise_shipping_discount)}}</strong>
    </div>
    @if($web_config['guest_checkout_status'] || auth('customer')->check())
...
<script>
    var cartData = {
        ecommerce: {
            ...
            value: <?php echo $sub_total + $total_tax + $total_shipping_cost - $coupon_dis - $total_discount_on_product - $order_wise_shipping_discount; ?>,
            items: [
