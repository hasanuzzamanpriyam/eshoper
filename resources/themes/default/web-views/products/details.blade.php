...
<div class="__inline-23">
    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                ...
                                <div class="px-4 pb-3 mb-3 mr-0 mr-md-2 bg-white __review-overview __rounded-10 pt-3">
                                    ...
                                    <div class="tab-content px-lg-3">
                                        ...
                                        <div class="tab-pane fade show active text-justify" id="overview" role="tabpanel">
                                            ...
                                            <div>
                                                <div class="text-center text-capitalize">
                                                    <img class="mw-90" src="{{asset('assets/front-end/img/icons/nodata.svg')}}" alt="">
                                        ...
                                        <div class="tab-pane fade" id="reviews" role="tabpanel">
                                            ...
                                            <div>
                                                <div class="text-center text-capitalize">
                                                    <img class="mw-100" src="{{asset('assets/front-end/img/icons/empty-review.svg')}}" alt="">
                    ...
                    <div class="col-12 position-static mt-3">
                        <div class="chat_with_seller-btns">
                            ...
                            <button class="btn w-100 d-block text-center" style="background: {{$web_config['primary_color']}};color:#ffffff" data-toggle="modal"
                                ...
                                <img src="{{asset('assets/front-end/img/chat-16-filled-icon.png')}}" class="mb-1" alt="">
        ...
        {{-- mobile app download link QR Code --}}
        <div class="my-3 pt-4 pb-3 bg-white">
            <div class="py-2 text-center">
                <span class=" __text-18px font-bold">
                    {{ translate('app_link_qr_title')}}
                </span>
            </div>
            <div class="py-2 text-center">
                <span class=" __text-14px">
                    {{ translate('app_link_qr_text')}}
                </span>
            </div>
            <div class="py-3 text-center">
                <img style="max-width:140px; margin: 0 auto;" src="{{asset('assets/front-end/img/app-link-qr/playstore-qr-link.png')}}">
            </div>
            <div class="py-2 text-center">
                <span class=" __text-14px">
                    <a class="font-semibold text-primary" href="https://play.google.com/store/apps/details?id=com.eshoperbd.eshop" target="_blank">{{ translate('app_link_qr_anchor')}}</a>
                </span>
            </div>
        </div>
    </div>
...
<script type="text/javascript"
    ...
    async="async"></script>
@php( $cats = json_decode($product->category_ids, true) )

<script>
    var productsData = {
        ecommerce: {
            currency: 'BDT',
            value: '{{$product->unit_price - $product->discount}}',
            items: [{
                item_id: '{{$product->id}}',
...
<script>
    var seller_products_data = {
        ...
        event: 'view_item_list_same_seller'
    };
    dataLayer.push(seller_products_data);
</script>

<script>
    var related_products_data = {
        ecommerce: {
            currency: 'BDT',
            items: [
        ...
        event: 'view_item_list_related_products'
    };
    dataLayer.push(related_products_data);
</script>
@endpush