...
<style>
    ...
    .select2-container .select2-selection--single {
        ...
        /* Adjust padding to match form-control */
        border: 1px solid #E7F5FF !important;
        /* Match border color */
...
<script>
    ...
    function shipping_method_select(get_value) {
        ...
        calculateDeliveryCharge(shipping_value.city);
...
<script>
    // Real-time delivery charge update when district changes
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#shipping-charge-value').html(response.shipping_cost);
                        // Update total payable (desktop)
    ...
    $(document).ready(function() {
        $('#city').on('change', function() {
            ...
            calculateDeliveryCharge(selectedDistrict);
        });
    });
</script>
