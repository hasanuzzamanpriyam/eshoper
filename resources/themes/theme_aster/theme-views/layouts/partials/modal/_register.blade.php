            ...
            <div class="modal-body px-4 px-lg-5">
                <div class="mb-4 text-center">
                    <img width="200" src="{{asset("storage/company") . "/" . $web_config['web_logo']->value}}"
                        onerror="this.src='{{theme_asset('assets/img/image-place-holder-2_1.png')}}'" alt=""
                        class="dark-support" />
                </div>
                <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <label for="agree" class="d-flex gap-1 align-items-center mb-0">
                                ...
                                {{translate('i_agree_with_the')}} <a href="{{route('terms')}}"
                                    class="text-info">{{ translate('Terms_&_Conditions') }}</a>
                            </label>
                        </div>
                    </div>

                    <div class="d-flex justify-content-center mt-4 mb-3">
                        <button type="submit" id="sign-up" class="btn btn-primary px-5"
