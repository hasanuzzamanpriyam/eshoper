            ...
            <div class="d-none d-lg-flex justify-content-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="javascript:" onclick="route_alert('{{ route('account-delete',[$customer_info['id']]) }}','{{ translate('want_to_delete_this_account?')}}')">
                ...
                <ul class="list-unstyled profile-menu gap-1 mt-3">
                    ...
                    <li class="{{Request::is ('refer-earn') || Request::is('refer-earn*') ? 'active' : ''}}" >
                        <a href="{{ route('refer-earn') }}">
                            <img width="20" src="{{theme_asset('assets/img/icons/refer-and-earn.svg')}}" class="dark-support" alt="">
                    ...
                    <li class="{{Request::is ('user-coupons') || Request::is('user-coupons*') ? 'active' : ''}}" >
                        <a href="{{route('user-coupons')}}">
                            <img width="20" src="{{theme_asset('assets/img/icons/coupon.svg')}}" class="dark-support" alt="">
