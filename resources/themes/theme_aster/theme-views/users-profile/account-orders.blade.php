                                        ...
                                        <tr>
                                                ...
                                                <div class="media gap-3 align-items-center mn-w200">
                                                    <div class="avatar rounded" style="--size: 3.75rem">
                                                        ...
                                                        <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                            src="{{ asset('storage/shop/'.$order->seller->shop->image)}}" class="img-fit dark-support rounded" alt="">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2 align-items-center">
                                                    ...
                                                    @else
                                                        <button class="btn btn-danger btn-action" title="{{ translate('Cancel')}}" onclick="cancel_message()">
                                                            <i class="bi bi-trash"></i>
                                                        </button>
                                                    @endif
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex gap-2 justify-content-between py-2 border-bottom d-sm-none">
                                        ...
                                        <div class="">
                                            ...
                                            @else
                                                <button class="btn btn-danger btn-action mb-1" title="{{ translate('Cancel')}}" onclick="cancel_message()">
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            @endif
                                        </div>
