                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="ext-center">
                                        ...
                                        <div class="my-4 text-center">
                                            <img width="243"
                                                src="{{theme_asset('assets/img/media/seller-registration.png')}}"
                                                loading="lazy" alt="" class="dark-support">
                                        </div>
                                        <p class="text-primary">{{translate('Open_your_and_start_selling.')}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input class="form-control" type="text" id="firstName" name="f_name"
                                                        value="{{old('f_name')}}" placeholder="{{translate('Ex')}} : Jhon"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input class="form-control" type="text" id="lastName" name="l_name"
                                                        value="{{old('l_name')}}" placeholder="{{translate('Ex')}} : Doe"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input class="form-control" type="tel" id="tel" name="phone"
                                                        value="{{old('phone')}}"
                                                ...
                                                <div class="media gap-3 align-items-center">
                                                    ...
                                                    <div class="media-body d-flex flex-column gap-1 upload-img-content">
                                                        ...
                                                        <div class="text-muted">
                                                            {{translate('NB')}}: {{translate('image_size_must_be_within')}}
                                                            2 MB <br>
                                                            {{translate('NB')}}: {{translate('image_type_must_be_within')}}
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input class="form-control" type="text" id="storeAddress"
                                                        ...
                                                        placeholder="{{translate('Ex_:_Shop_-12_Road-8') }}" required>
                                                </div>
                                            </div>
