                    ...
                    <div class="d-flex gap-4 flex-wrap">
                                ...
                                <div class="media-body d-flex flex-column gap-2">
                                    ...
                                    <ul class="list-unstyled list-inline-dot fs-12">
                                        ...
                                        @if ($minimum_order_amount ==1 && $minimum_order_amount_by_seller ==1)
                                            <li>{{ \App\CPU\Helpers::currency_converter($shop->seller->minimum_order_amount)}} {{translate('minimum_order_amount')}} </li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="media-body d-flex flex-column gap-2">
                                    ...
                                    @if($shop['id'] == 0)
                                        @php($minimum_order_amount=\App\CPU\Helpers::get_business_settings('minimum_order_amount'))
                                            <span class="text-sm-nowrap">{{ \App\CPU\Helpers::currency_converter($minimum_order_amount)}} {{translate('minimum_order_amount')}}</span>
                                        @else
                                            <span class="text-sm-nowrap">{{ \App\CPU\Helpers::currency_converter($shop->seller->minimum_order_amount)}} {{translate('minimum_order_amount')}}</span>
                                        @endif
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-wrap flex-lg-column flex-lg-down-grow-1 justify-content-center gap-3">
                            ...
                            @else
                                ...
                                data-titletext="{{translate('are_you_sure')}}?" data-titletext2="{{translate('want_to_unfollow_this_shop')}}!" data-cancelbuttontext="{{translate('cancel')}}" onclick="shopFollowAction('{{$shop['id']}}')"> {{($follow_status == 0?translate('Follow'):translate('Unfollow'))}}</button>
                            @endif
