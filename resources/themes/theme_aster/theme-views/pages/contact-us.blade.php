                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="media gap-3">
                                ...
                                <div class="media-body">
                                    ...
                                    <a
                                        href="mailto:{{\App\CPU\Helpers::get_business_settings('company_email')}}">{{\App\CPU\Helpers::get_business_settings('company_email')}}</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="email" id="email" class="form-control" name="email"
                                                value="{{ old('email') }}" placeholder="{{ translate('email_address') }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="subject" value="{{ old('subject') }}"
                                                class="form-control" rows="6" placeholder="{{ translate('short_title') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="message" id="message" class="form-control" rows="6"
                                        placeholder="{{ translate('type_your_message_here..') }}"> {{ old('subject') }} </textarea>
                                </div>
                                {{-- recaptcha --}}
